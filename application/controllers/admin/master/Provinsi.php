...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Provinsi extends MY_Controller {
...

		{
			...
			$data['page_name'] = "Provinsi";

			$this->template->load('admin/template/template','admin/master/provinsi/all-tbl_provinsi',$data);
...

		{
			...
			$this->load->view('admin/master/provinsi/add-tbl_provinsi');
	...
	$this->form_validation->set_rules('dt[value]', '<strong>Value</strong>', 'required');
...

		{
			...
			$data['tbl_provinsi'] = $this->mymodel->selectDataone('tbl_provinsi',array('id'=>$id));
			$data['page_name'] = "Provinsi";

			$this->load->view('admin/master/provinsi/edit-tbl_provinsi',$data);
...

		{
			...
			redirect('admin/master/provinsi');
