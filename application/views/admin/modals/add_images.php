<form method="POST" action="<?= base_url('admin/project/add_image/'.$tbl_project['id'])?>" id="add-image" enctype="multipart/form-data" class="form-horizontal">
	<div class="form-group"> 
		<div class="col-sm-12">
			<div class="show_error"></div>
			<div class="row"> 
				<div class="col-md-6 col-xs-12">
					<img src="<?= base_url('webfile/project/default.jpg') ?>" alt="User Image" width="100%" height="250px" id="preview_image-add">
				</div>
				<div class="col-md-6 col-xs-12">
