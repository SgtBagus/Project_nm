                    ...
                    <table class="table table-bordered" style="width: 100%">
                        ...
                        if($file_detail){
                          ...
                          foreach($file_detail as $img){
                            ...
                            <tr id="detail_image_edit">
                              ...
                              <td>
                                <a href="<?= base_url('admin/project/editOneImage/').$img['id']?>">
                      ...
                      <tfoot>
                        <td colspan="2" align="center" id="btn_image_add">
                          ...
                          <?php 
                          $project_image = $this->mymodel->selectWithQuery("SELECT count(id) as count from file WHERE table_id = ".$tbl_project['id']." AND file.table = 'tbl_project_gambar'");
                          ?>
                          <?php if($project_image[0]['count'] == 6) { 
                            echo '<button type="button" class="btn btn-sm btn-primary" disabled><i class="fa fa-file"></i> Detail Gambar Tidak bisa lebih dari 6 Gambar</button>';
                          }else{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php $this->load->view('admin/modals/add_images', $tbl_project); ?>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" align="center">
        ...
        <div class="box-footer" align="center">
          ...
          <a href="<?= base_url('admin/project/delete_Allimage/'.$tbl_project['id'])?>">
            <button type="button" class="btn btn-danger btn-send" ><i class="fa fa-trash"></i> Hapus</button>
          </a>
        </div>
      </div>
