<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= base_url('admin/master/user') ?>">User</a></li>
			...
			<div class="col-md-6">
				<div class="panel">
					...
					<div class="panel-body">
						<form action="<?= base_url('admin/master/user/updateUser') ?>" enctype="multipart/form-data" method="POST" id="upload">
...
<script type="text/javascript">
	...
	function loaddata() {
		var t = $("#mytable").dataTable({
			...
			processing: true,
			serverSide: true,
			ajax: {"url": "<?= base_url('admin/master/user/json_activity') ?>/<?= $user_data['id'] ?>", "type": "POST"},
			columns: [
