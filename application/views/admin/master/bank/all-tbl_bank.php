 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" tbl_bank="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-form">
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" tbl_bank="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-delete">

      <div class="modal-dialog modal-sm">

          <div class="modal-content">

              <form id="upload-delete" action="<?= base_url('admin/master/bank/delete') ?>">
  ...
  <div class="modal fade" id="modal-impor">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="<?= base_url('fitur/impor/tbl_bank') ?>" method="POST"  enctype="multipart/form-data">
            ...
            var table = '<table class="table table-bordered" id="mytable">'+
             ...
             $("#load-table").html(table)
              ...
              var t = $("#mytable").dataTable({
                ...
                ajax: {"url": "<?= base_url('admin/master/bank/json?status=') ?>"+status, "type": "POST"},
                    ...
                    { targets : [2],
                        ...
                        render : function (data, type, row, meta) {
                              ...
                              if(row['status']=='ENABLE'){
                                ...
                                var htmls = '<a href="<?= base_url('admin/master/bank/status/') ?>'+row['id']+'/DISABLE">'+
                                ...
                                var htmls = '<a href="<?= base_url('admin/master/bank/status/') ?>'+row['id']+'/ENABLE">'+
