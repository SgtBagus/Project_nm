                                ...
                                <div class="col-md-12"> 
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Ingin Menjadi Mitra ?</label>
                                            <p class="help-block">Mohon Baca Syarat dan Ketentuan berikut ini !</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="<?= base_url('#') ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12"> 
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">  
                                            <a href="#"><button class="btn btn-block btn-primary btn-sm"><i class="fa fa-send"></i> Kirim</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
