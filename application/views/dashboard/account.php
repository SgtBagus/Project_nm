                            ...
                            <div class="tab-content">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[jk]" style="width: 100%">
                                                                    ...
                                                                    <option value="L" <?php if ($user['jk'] == 'L') {
                                                                                            echo "selected";
                                                                                        } ?>>Laki Laki</option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[wrg_negara]" style="width: 100%">
                                                                    ...
                                                                    <option value="WNI" <?php if ($user['wrg_negara'] == 'WNI') {
                                                                                            echo "selected";
                                                                                        } ?>>WNI</option>
                                                                    <option value="WNA" <?php if ($user['wrg_negara'] == 'WNA') {
                                                                                            echo "selected";
                                                                                        } ?>>WNA</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[agama_id]" style="width: 100%">
                                                                    ...
                                                                    foreach ($tbl_agama as $key => $value) { ?>
                                                                        <option value="<?= $value['id'] ?>" <?php if ($user['agama_id'] == $value['id']) {
                                                                                                                    echo "selected";
                                                                                                                } ?>><?= $value['value'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[pendidikan_id]" style="width: 100%">
                                                                    ...
                                                                    foreach ($tbl_pendidikan as $key => $value) { ?>
                                                                        <option value="<?= $value['id'] ?>" <?php if ($user['pendidikan_id'] == $value['id']) {
                                                                                                                    echo "selected";
                                                                                                                } ?>><?= $value['value'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[status_kawin]" style="width: 100%">
                                                                    ...
                                                                    <option value="NO" <?php if ($user['status_kawin'] == 'NO') {
                                                                                            echo "selected";
                                                                                        } ?>>Belum Menikah</option>
                                                                    <option value="YES" <?php if ($user['status_kawin'] == 'YES') {
                                                                                            echo "selected";
                                ...
                                <div class="tab-pane" id="tab_password">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="box-body">
                                                <form action="<?= base_url('dashboard/editpassword') ?>" method="post" enctype="multipart/form-data" id="editpassword">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[provinsi_id]" id="provinsi" style="width: 100%">
                                                                    ...
                                                                    foreach ($tbl_provinsi as $key => $value) { ?>
                                                                        <option value="<?= $value['id'] ?>" <?php if ($user['provinsi_id'] == $value['id']) {
                                                                                                                    echo "selected";
                                                                                                                } ?>><?= $value['value'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[kota_id]" id="kota" style="width: 100%">
                                                                    ...
                                                                    <?php foreach ($tbl_kota as $key => $value) { ?>
                                                                        <option id="kota-<?= $value['id'] ?>" value="<?= $value['id'] ?>" <?php if ($user['kota_id'] == $value['id']) {
                                                                                                                                                    echo "selected";
                                                                                                                                                } ?>><?= $value['value'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[sumberdana_id]" style="width: 100%">
                                                                    ...
                                                                    foreach ($tbl_sumberdana as $key => $value) { ?>
                                                                        <option value="<?= $value['id'] ?>" <?php if ($user['sumberdana_id'] == $value['id']) {
                                                                                                                    echo "selected";
                                                                                                                } ?>><?= $value['value'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[pekerjaan_id]" style="width: 100%">
                                                                    ...
                                                                    <?php
                                                                    $tbl_pekerjaan = $this->mymodel->selectData("tbl_pekerjaan");
                                                                    foreach ($tbl_pekerjaan as $key => $value) { ?>
                                                                        <option value="<?= $value['id'] ?>" <?php if ($user['pekerjaan_id'] == $value['id']) {
                                                                                                                    echo "selected";
                                                                                                                } ?>><?= $value['value'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[gaji_id]" style="width: 100%">
                                                                    ...
                                                                    foreach ($tbl_gaji as $key => $value) { ?>
                                                                        <option value="<?= $value['id'] ?>" <?php if ($user['gaji_id'] == $value['id']) {
                                                                                                                    echo "selected";
                                                                                                                } ?>><?= $value['value'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="dt[bank_id]" style="width: 100%">
                                                                    ...
                                                                    foreach ($tbl_bank as $key => $value) { ?>
                                                                        <option value="<?= $value['id'] ?>" <?php if ($user['bank_id'] == $value['id']) {
                                                                                                                    echo "selected";
                                                                                                                } ?>><?= $value['value'] ?></option>
                                                                    <?php } ?>
                                                                </select>
